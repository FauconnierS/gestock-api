 ...
 * @ApiResource
 * @UniqueEntity("email", message="Un utilisateur avec cet email existe déja")
 * 
 */
class User implements UserInterface
{
     ...
     * @Groups({"customers_read","invoices_read","invoices_subresource"})
     * @Assert\NotBlank(message="L'email doit être obligatoire")
     ...
     * @Assert\Length(min=3, max=255, minMessage="Le Prénom doit avoir au moins 3 caractères", maxMessage="Le Prénom doit avoir au moins 3 caractères")
     */
    private $firstName;
